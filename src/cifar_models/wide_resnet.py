...
class Wide_ResNet(nn.Module):
    def __init__(self, depth, widen_factor, dropout_rate, num_classes, factor=1): #for TINs 64x64 images, set factor=2, use stride on first block
        ...
        self.layer1 = self._wide_layer(wide_basic, nStages[1], n, dropout_rate, stride=factor)
